...
#' @import coop
#' @export similarities_items
#' @name similarities_items
...
#'
#'
similarities_items <- function(ratings_wide){
  coop::cosine(ratings_wide)   # the cosine function calculates cosine similarity between columns (items)
