...
#' @description Randomly splits the dataset into training and test sets based on the proportion specified
...
#'   set eg. 0.8 denotes 80%% assigned to training and 20%% assigned to testing
