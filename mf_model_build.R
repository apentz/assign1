...
#'   ID's and Ratings in the first 3 columns respectively. The output is the
#'   model specified which can then be used to predict ratings.
#' @import dplyr
#' @import NNLM
...
#'
#' @param train_wide The input dataset is a long matrix which contains User
...
#'
#' @param alpha L2 regularisation for H
#' @param beta L2 regularisation for W
#' @param bias adding a bias term
#'
